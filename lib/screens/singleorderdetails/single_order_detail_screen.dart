...
import '/screens/singleorderdetails/single_order_details_view_model.dart';
...
class SignleOrderDetailsScreen extends StatelessWidget {
  ...
  SignleOrderDetailsScreen(
      ...
      Key? key})
      : super(key: key);
  final _controller = Get.put(SingleDetailsViewModel());
  @override
                ...
                : Container(
                    ...
                    child: !isDeliverd
                        ...
                        : isAccept
                            ? Container(
                                child:
                                    AppText.text("In Way", color: Colors.blue),
                              )
                            : isCancel
                                ? Container(
                                    child: AppText.text("Canceld",
                                        color: Colors.red),
                                  )
                                : MyButtonwidget(
                                    color: Colors.green,
